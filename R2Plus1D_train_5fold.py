...
ROOT_DIR = "/workspace/Master_Dataset_Cropped_YOLO"
...
MODEL_TAG = "R2Plus1D_YOLO"
RESULTS_DIR = "/workspace/results_R2Plus1D_5fold_YOLO"
...
def train_one_fold(fold_idx, train_indices, val_indices,
    ...
    ckpt_path = os.path.join(RESULTS_DIR, f"R2Plus1D_YOLO_best_fold{fold_idx}.pth")
